...
export const siteData = {
  ...
  works: {
    filters: ['All', 'Video', 'Link', 'Image', 'Gallery', 'Content'],
    items: [
      {
        title: 'Prism — Multi-Business, Multi-Vendor Marketplace Platform',
        type: 'Link',
        slug: 'prism-marketplace-platform',
        href: 'https://prism.devfolio.net/',
      },
      {
  ...
  blog: {
    posts: [
      ...
      },
      {
        ...
        excerpt:
          'After years of dreaming about becoming a developer, I’m finally living that goal. This is my final year at the Faculty of Computer Science, and I’m maintaining a GPA of 3.55+ — Alhamdulillah\u2026',
      ...
      },
      {
        ...
        excerpt:
          'My journey started at the Faculty of Engineering, Cairo University, where I studied Biomedical Engineering (HEM) for four years (2018–2022). It was a valuable chapter—but deep down, I always knew my real passion was programming and building things with computers.\u2026',
