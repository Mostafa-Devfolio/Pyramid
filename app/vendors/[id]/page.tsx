...
export default async function VendorsPage({params}: {params: Promise<{id: string}>}) {
  ...
  return (<>
    <div className='mb-3 cursor-default container bg-gray-800 text-white mx-auto grid grid-cols-1 md:flex md:items-center md:gap-4 border-b p-3 rounded-br-2xl rounded-bl-2xl'>
      <h1 className="text-center whitespace-nowrap bg-linear-to-r md:w-fit from-purple-300 to-red-400 bg-clip-text text-transparent">{vendor.name}</h1>
      <div className='grid grid-cols-2 md:flex md:justify-between md:w-full'>
    ...
    <div className='container mx-auto grid grid-cols-1 sm:grid-cols-4 gap-3'>
