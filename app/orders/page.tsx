            ...
            {saveOrders.map((order: any) => {
                return <div key={order.id} className="border stroke-1 p-3 rounded grid grid-cols-2">
                    ...
                    <div className='flex justify-end'>
                        <Button className='cursor-pointer' onClick={() => {setOpen(true); setOrderIDD(order.id)}}>Cancel</Button>
                    </div>
                    {order.id === orderIDD && <div>
          ...
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              ...
              <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                <button
                  type="button"
                  onClick={() => {setOpen(false); cancelOrder(order.documentId)}}
            ...
            <h1 className='text-center my-3'>No current orders</h1>
